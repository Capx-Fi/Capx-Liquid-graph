...
let MasterAddress = Address.fromString("0x30B9A8279298Ba8d37Bf76b9f2A805D656fC1C07")
...
export function handleWithdrawLock(event: Withdraw): void {
  ...
  export function handleTransferLock(event: TransferLock): void {
    ...
    if (_receiverAddress != Address.fromString("0x1428c7f929b3Ac5d5c6619FC3F9C722d2cfC66A5")){
